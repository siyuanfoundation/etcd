...
func HandleHealth(lg *zap.Logger, mux *http.ServeMux, c *clientv3.Client) {
	...
	mux.Handle(etcdhttp.PathHealth, etcdhttp.NewHealthHandler(lg, func(excludedAlarms etcdhttp.StringSet, serializable bool) etcdhttp.Health { return checkHealth(c) }))
}
...
func HandleProxyHealth(lg *zap.Logger, mux *http.ServeMux, c *clientv3.Client) {
	...
	mux.Handle(etcdhttp.PathProxyHealth, etcdhttp.NewHealthHandler(lg, func(excludedAlarms etcdhttp.StringSet, serializable bool) etcdhttp.Health { return checkProxyHealth(c) }))
}
